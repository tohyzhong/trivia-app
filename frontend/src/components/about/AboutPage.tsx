        ...
        <main>
          <section className="about-section">
            ...
            <ul className="feature-list">
              ...
              <li>
                Leaderboard to compare your stats with friends and other
                players.
              </li>
              <li>
            ...
            <p>
              ...
              relief, we wanted to create an app that not only entertains but
              also helps people stay connected over shared experiences. The Rizz
              Quiz is designed to let you test your meme knowledge, connect with
