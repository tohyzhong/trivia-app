...
const Settings: React.FC = () => {
  ...
  const handlePasswordResetRequest = async () => {
    try {
      ...
      alert('Password reset request sent! Please check your email for further instructions.');
    } catch (err) {
  ...
  const handleEmailChangeRequest = async () => {
    try {
      ...
      alert('Email change request sent! Please check your new email to verify the change.');
    } catch (err) {
  ...
  return (
    <div className="settings-container">
      ...
      <div className="user-info">
        <img src={user?.profilePicture || defaultAvatar} alt={username} className="profile-picture" />
        <div>
          ...
          <p>
            ...
            <span
              className={`verification-status ${verified ? 'verified' : 'not-verified'}`}
            >
      ...
      <div className="settings-actions">
        ...
        <div className="email-change">
          ...
          />
          <button onClick={handleEmailChangeRequest}>Request Email Change</button>
        </div>
